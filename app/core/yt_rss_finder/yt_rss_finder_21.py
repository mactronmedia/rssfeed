...
class YouTubeChannel:
    ...
    async def get_channel_info(entry: str) -> dict:
        ...
        if feed_url:
            await YouTubeParser.channel_data(feed_url)
        else:
    ...
    async def process_rss_feed(entry: str) -> dict:
        ...
        if channel_id:
            await YouTubeParser.channel_data(entry)
...
if __name__ == "__main__":
    async def main():
        # Example usage
        entry = 'https://www.youtube.com/feeds/videos.xml?channel_id=UCHnyfMqiRRG1u-2MsSQLbXA'
