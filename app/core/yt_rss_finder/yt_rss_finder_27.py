...
from utilities.helpers import async_retry
...
class YouTubeChannel:
    @staticmethod
    @async_retry(retries=3, delay=1, backoff=2, jitter=True)
...
async def main():
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        entry = 'https://www.youtube.com/feeds/videos.xml?channel_id=UCUyeluBRhGPCW4rPe_UvBZQ'
