...
from app.schemas.youtube_feed import YouTubeChannel, YouTubeFeedItem, YouTubeFeedResponse
        ...
        async with aiohttp.ClientSession() as session:
            try:
                ...
                channel = YouTubeChannel(
                    ...
                    link=feed_data.feed.get("link", f"https://www.youtube.com/channel/{channel_id}"),
                    description=feed_data.feed.get("subtitle", ""),
                    published=datetime(*feed_data.feed.get("published_parsed", datetime.utcnow().timetuple())[:6]),
                    fetched_at=datetime.utcnow(),
                )
